...
use crate::commands::{create_store, open_store, get_store_list};
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![create_store, open_store, get_store_list, receive_drawing, send_drawing, fetch_store, fetch_all_stores, add_item, fetch_item])
