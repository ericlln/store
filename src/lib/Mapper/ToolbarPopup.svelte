...
<div class="popup-container" bind:this={ref}>
	<div class="toolbar-layout">
		{#if type === 'shape'}
			<Button fontSize="xl" popupText="Clear Drawing" popupDir="r" on:click={onClear}>
				<Icon
			...
			<Button fontSize="xl" popupText="Undo (Ctrl+Z)" popupDir="r" on:click={onUndo}>
				<Icon
					viewBox="0 -960 960 960"
			...
			<Button fontSize="xl" popupText="Redo (CTRL+Y)" popupDir="r" on:click={onRedo}>
				<Icon
					viewBox="0 -960 960 960"
		...
		{/if}
		<Button fontSize="xl" popupText="Help (F1)" popupDir="r" on:click={onHelp}>
			<Icon
				viewBox="0 -960 960 960"
